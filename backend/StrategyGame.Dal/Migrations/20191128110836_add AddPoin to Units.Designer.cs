...
namespace StrategyGame.Dal.Migrations
{
    ...
    [Migration("20191128110836_add AddPoin to Units")]
    partial class addAddPointoUnits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StrategyGame.Model.Entities.Ranglist", b =>
                {
                    ...
                    b.Property<int>("RanglistCollectionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RanglistCollectionId");
            ...
            modelBuilder.Entity("StrategyGame.Model.Entities.RanglistCollection", b =>
                {
                    b.Property<int>("RanglistCollectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("RanglistCollectionId");

                    b.HasIndex("GameId");

                    b.ToTable("RanglistCollections");
                });
            ...
            modelBuilder.Entity("StrategyGame.Model.Entities.Ranglist", b =>
                {
                    b.HasOne("StrategyGame.Model.Entities.RanglistCollection", "RanglistCollection")
                        .WithMany()
                        .HasForeignKey("RanglistCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StrategyGame.Model.Entities.RanglistCollection", b =>
                {
                    b.HasOne("StrategyGame.Model.Entities.Game", "Game")
                        .WithMany()
